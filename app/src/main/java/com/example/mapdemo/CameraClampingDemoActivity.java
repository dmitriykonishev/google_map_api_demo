...
/**
 * Это показывает, как ограничить камеру конкретными границами и уровнями масштабирования.
 */
public class CameraClampingDemoActivity extends AppCompatActivity
    ...
    /**
     * Внутренний минимальный уровень масштабирования, который можно переключить с помощью демонстрации.
     */
    private float mMinZoom;

    /**
     * Внутренний максимальный уровень масштабирования, который можно переключать с помощью демонстрации.
     */
    ...
    /**
     * Перед тем, как карта будет готова, многие вызовы не удастся.
     * Это нужно вызвать во всех точках входа, которые вызывают методы в API Карт Google.
     */
    ...
    /**
     * Обработчик кликов для фиксации кнопки Аделаида.
     * @param view
     */
    ...
    /**
     * Обработчик кликов для фиксации кнопки Pacific.
     * @param view
     */
